-- ============================================================================
-- POPULATION-B SUPPLIER REPAIR (TDA, REQ-230/233) — PREFLIGHT (READ-ONLY)
-- ============================================================================
-- Stage 1 of the controlled Population-B supplier repair for EXACTLY two requests
-- whose issuer was CONFIRMED BY HUMAN REVIEW (2026-08-20) as TDA:
--   REQ-11/08/2026-230 (company 2, AlplaSOPRO)    -> SupplierId 34
--   REQ-11/08/2026-233 (company 1, AlplaPLASTICO) -> SupplierId 34
...
-- SELECT/PRINT only — no writes. Run before po-flow-population-b-tda-230-233-repair.sql
-- and STOP unless every row is PASS and the final state is PENDING_REPAIR
-- (or ALREADY_REPAIRED across both).
-- ============================================================================
...
INSERT INTO @targets VALUES
 ...
 (N'REQ-11/08/2026-233', '091cffd1-921b-4cf6-b6d3-843500820538', 1, 34, N'5410002857', '97d0aeb4-6352-4715-9d8f-a5d5759c08e3', N'b4bc9eb55fdd0900da895a5cedc96b6bd95245a11b644dae34cc50fafbae005d');
