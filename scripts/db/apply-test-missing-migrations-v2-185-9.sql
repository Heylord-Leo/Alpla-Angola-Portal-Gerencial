-- ============================================================================
-- SAFE MIGRATION SCRIPT FOR TEST ENVIRONMENT
...
--
-- PRE-REQUISITES:
--   - Run against [Portal-Gerencial-Test] ONLY.
...
BEGIN
    RAISERROR('SAFETY CHECK FAILED: This script must run against [Portal-Gerencial-Test]. Current database: %s', 16, 1, DB_NAME());
    RETURN;
END;
GO

PRINT '=== Target database confirmed: [Portal-Gerencial-Test] ===';
GO
