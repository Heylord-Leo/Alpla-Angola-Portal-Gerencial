...
public class AttendancePunchDto
{
    ...
    /// <summary>
    /// Raw Innux direction code from TipoProcessado.
    /// Known values: "EN" (entry), "SA" (exit), "17" (alternate entry), "18" (alternate exit).
    /// </summary>
    public string Direction { get; set; } = "";

    /// <summary>
    /// Human-readable direction label: "Entrada", "Saída", or "Código XX" for truly unknown codes.
    /// </summary>
    ...
    /// <summary>Whether the direction was interpreted by Portal custom rules (e.g., multiple Code 17).</summary>
...
public class AttendancePeriodDto
{
    ...
    /// <summary>Indicates if there is a conflict between Innux processed data and Portal interpretation.</summary>
    public bool HasPortalConflict { get; set; }

    /// <summary>Explanation message if there is a conflict between Innux and Portal.</summary>
    public string? PortalConflictMessage { get; set; }
}
