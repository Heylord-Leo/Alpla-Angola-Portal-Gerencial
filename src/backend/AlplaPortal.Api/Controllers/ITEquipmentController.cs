...
public class ITEquipmentController : BaseController
{
    ...
    public IActionResult ChangeUser(Guid id)
    {
        // 410 Gone: The requested resource is no longer available.
        return StatusCode(410, new { detail = "A ação 'Trocar utilizador' foi descontinuada. Por favor, realize a devolução do equipamento e em seguida crie um novo Termo de Entrega." });
    }
