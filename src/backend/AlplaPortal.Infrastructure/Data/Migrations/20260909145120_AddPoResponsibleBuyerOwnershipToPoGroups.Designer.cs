...
namespace AlplaPortal.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909145120_AddPoResponsibleBuyerOwnershipToPoGroups")]
    partial class AddPoResponsibleBuyerOwnershipToPoGroups
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("TotalsBeforeMax")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalsBeforeMin")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ApprovalBatchId", "CycleNumber")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalBatchAdjustment_Batch_Cycle");

                    b.ToTable("ApprovalBatchAdjustments");
                });

            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchAdjustmentFieldChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ApprovalBatchAdjustmentFieldChanges");
                });

            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchAdjustmentReason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AdjustmentId", "ReasonCode", "RequestLineItemId")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalBatchAdjustmentReason_Cycle_Code_Item");

                    b.ToTable("ApprovalBatchAdjustmentReasons");
                });

            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchAdjustmentResolution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AdjustmentId", "ActorType")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalBatchAdjustmentResolution_Cycle_Actor");

                    b.ToTable("ApprovalBatchAdjustmentResolutions");
                });

            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchCandidateReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ApprovalBatchItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AdjustmentId", "ApprovalBatchItemId", "QuotationItemId")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalBatchCandidateReview_Cycle_Item_QuotationItem");

                    b.ToTable("ApprovalBatchCandidateReviews");
                });
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchItem", b =>
                {
                    ...
                    b.Property<DateTime?>("WinnerSelectedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("WinnerSelectedByUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("WinnerSelectionJustification")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchItemCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("HasReconciliationWarnings")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("LineAdjustmentJustificationSnapshot")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<DateTime?>("QuotationDocumentDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("QuotationDocumentNumber")
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("QuotedDescription")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<string>("ReconciliationJustificationSnapshot")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("ReconciliationStatusSnapshot")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("UnitTextSnapshot")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.HasKey("Id");

                    b.HasIndex("ApprovalBatchItemId")
                    ...
                    b.HasIndex("ApprovalBatchItemId", "QuotationItemId")
                        .IsUnique()
                        .HasDatabaseName("UX_ApprovalBatchItemCandidate_Item_QuotationItem");

                    b.ToTable("ApprovalBatchItemCandidates");
                });
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.Quotation", b =>
                {
                    ...
                    b.Property<Guid?>("RevisesQuotationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.RequestPoGroup", b =>
                {
                    ...
                    b.Property<Guid?>("PoResponsibleBuyerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchAdjustmentFieldChange", b =>
                {
                    b.HasOne("AlplaPortal.Domain.Entities.ApprovalBatchAdjustment", "Adjustment")
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchItem", b =>
                {
                    ...
                    b.HasOne("AlplaPortal.Domain.Entities.ApprovalBatchItemCandidate", "SelectedCandidate")
                        .WithMany()
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.ApprovalBatchItemCandidate", b =>
                {
                    b.HasOne("AlplaPortal.Domain.Entities.ApprovalBatchItem", "ApprovalBatchItem")
                        .WithMany("Candidates")
                        .HasForeignKey("ApprovalBatchItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ApprovalBatchItem");
            ...
            modelBuilder.Entity("AlplaPortal.Domain.Entities.Quotation", b =>
                {
                    ...
                    b.HasOne("AlplaPortal.Domain.Entities.Quotation", "RevisesQuotation")
                        .WithMany()
                        .HasForeignKey("RevisesQuotationId")
                        .OnDelete(DeleteBehavior.Restrict);
