...
export function QueueSummary({ areaApprovals, finalApprovals, pendingContracts }: QueueSummaryProps) {
    ...
    const cards: Array<{ id: string; label: string; count: number; icon: typeof ClipboardList; color: string; displayValue?: string; tooltip?: string }> = [
        { id: 'total', label: 'Total Pendente', count: totalCount, icon: ClipboardList, color: 'bg-blue-500' },
        ...
        { id: 'alerts', label: 'Com Alertas', count: alertCount, icon: AlertCircle, color: 'bg-rose-500', tooltip: 'Pedidos com pontos de atenção na análise.' },
